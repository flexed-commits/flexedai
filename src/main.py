    ...
    async def show_ai_chat_leaderboard(interaction, is_server, view):
        ...
        if is_server and guild:
            query = '''
                ...
                LIMIT 10
            '''
            results = db_query(query, (str(guild.id), today), fetch=True)
            ...
            query = '''
                ...
                LIMIT 10
            '''
            results = db_query(query, (str(today),), fetch=True)
    ...
    async def show_tictactoe_leaderboard(interaction, is_server, difficulty, view):
        ...
        if is_server and guild:
            query = '''
                ...
                LIMIT 10
            '''
            results = db_query(query, (str(guild.id), difficulty, today), fetch=True)
            ...
            query = '''
                ...
                LIMIT 10
            '''
            results = db_query(query, (difficulty, str(today)), fetch=True)
